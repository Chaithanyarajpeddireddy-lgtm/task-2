const students = [  //---> Symbol for list data type...
        ...
        {id: "S008", name: "Dinesh", s1: 62, s2: 70, s3: 58, s4: 47, s5: 55},      //Every line contains keys and values....
...
function loadData(){
        ...
        stable += `</table>`;
        document.getElementById("studentdata").innerHTML = stable;
    }    